...
class CardStreamController {
  ...
  changeDirection() {
    this.direction *= -1;
    this.velocity = Math.max(this.velocity, 150);
    this.updateSpeedIndicator();
  }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.toggleAnimation = () => cardStream.toggleAnimation();
  window.resetPosition = () => cardStream.resetPosition();
  window.changeDirection = () => cardStream.changeDirection();
